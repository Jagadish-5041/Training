...
class Parallelogram extends Component{
    render () {
        ...
        <input type="textfield" id="tl" placeholder="enter base"/>
        <br/>
        <input type="textfield" id="tb" placeholder="enter heigth"/>
        <br />
...
const tqr=()=>{
    ...
    let ans=l*b;
    document.getElementById("to").innerHTML="Area of Parallelogram is : "+ans.toFixed(2);
}
...
export {Square,Rectangle,Circle,Cube,Parallelogram};